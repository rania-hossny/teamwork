        ...
        <div className="container-fluid">
            ...
            />
                    ...
                    <Card.Body className="text-center">
                        <Card.Title><strong>{users.name !== "undefined" ? users.name : null}</strong></Card.Title>
                
                        <Card.Title style={{color:"rgba(0,0,0,0.3)"}}>
                           <strong>{users.bio !== "undefined" ? users.bio : null}</strong>
                        </Card.Title>
                        <Card.Title>
                           <strong>{users.track !== "undefined" ? users.track : null} </strong>
                        </Card.Title>
                        <Card.Title>
                           <strong> {users.email !== "undefined" ?<HiOutlineMail /> : null} {users.email !== "undefined" ? users.email : null}</strong>
                        </Card.Title>
                        <Card.Title >
                           <strong> {users.phone !== "undefined" ?<AiOutlinePhone/> : null} {users.phone !== "undefined" ? users.phone : null}</strong>
                        </Card.Title>
                        <Card.Title >
                           <strong> {users.address !== "undefined" ?<FaRegAddressCard/> : null} {users.address !== "undefined" ? users.address : null}</strong>
                        </Card.Title>
